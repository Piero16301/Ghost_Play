            ...
            if (call.method == "getRecentAudios") {
                                        ...
                                        ?.use { cursor ->
                                            ...
                                            while (cursor.moveToNext()) {
                                                ...
                                                if (mime ==
                                                    ...
                                                    voiceNotesDocId = cursor.getString(idIdx)
                                                    break
                                                }
                                            }
                                        }
                                            ...
                                            ?.use { cursor ->
                                                ...
                                                while (cursor.moveToNext()) {
                                                    ...
                                                    if (name.endsWith(".opus")) {
                                                        ...
                                                        allOpusFiles.add(
                                                                FileInfo(fileUri, name, date, size)
                                                        )
                                                    }
                                                }
                                            }
                ...
                Thread {
                            try {
                                        ...
                                        ?.use { cursor ->
                                            ...
                                            while (cursor.moveToNext()) {
                                                ...
                                                if (mime == DocumentsContract.Document.MIME_TYPE_DIR
                                                    ...
                                                    val name = cursor.getString(nameIdx) ?: ""
                                                    if (name == ".Statuses") {
                                                        statusesDocId = cursor.getString(idIdx)
                                                        break
                                                    }
                                                }
                                            }
                                ...
                                val allStatusFiles = mutableListOf<Map<String, Any>>()
                                val retriever = MediaMetadataRetriever()
                                ...
                                val sortedFiles =
                                        allStatusFiles.sortedByDescending { it["date"] as Long }
                                runOnUiThread { result.success(sortedFiles) }
                            } catch (e: Exception) {
                                runOnUiThread { result.error("READ_ERROR", e.message, null) }
                            }
                        }
                ...
                val uriString = call.argument<String>("uri")
                val fileName = call.argument<String>("fileName") ?: "temp_file"
                ...
                Thread {
                            try {
                                ...
                                if (inputStream != null) {
                                    val tempFile =
                                            java.io.File(applicationContext.cacheDir, fileName)
                                    ...
                                    runOnUiThread {
                                        result.error("CACHE_ERROR", "InputStream is null", null)
                                    }
                                }
                            } catch (e: Exception) {
                                runOnUiThread { result.error("CACHE_ERROR", e.message, null) }
                            }
                        }
                        .start()
            } else {
